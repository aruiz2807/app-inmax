<div class="flex flex-col gap-3 pb-3 border-b border-neutral-100 mb-3 lg:flex-row lg:items-end lg:justify-between">
    <div class="flex flex-wrap items-end gap-2">
        <div>
            <label for="appointments-date-from" class="block text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1">Desde</label>
            <input
        ...
        <div>
            <label for="appointments-date-to" class="block text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1">Hasta</label>
            <input
    ...
    <div class="flex items-center gap-2">
        <span class="text-xs font-semibold text-neutral-500 uppercase tracking-wide">Acceso rápido:</span>
