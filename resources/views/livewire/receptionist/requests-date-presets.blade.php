<div class="flex flex-col gap-3 pb-3 border-b border-neutral-100 mb-3 lg:flex-row lg:items-end lg:justify-between">
    <div class="flex flex-wrap items-end gap-2">
        <div>
            <label for="requests-date-from" class="block text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1">Desde</label>
            <input
        ...
        <div>
            <label for="requests-date-to" class="block text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1">Hasta</label>
            <input
                id="requests-date-to"
                type="date"
